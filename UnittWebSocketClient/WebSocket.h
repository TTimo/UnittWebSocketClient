...
/**
 * True if the client should verify the Sec-WebSocket-Accept value sent by the server. Since
 * many of the web socket servers may not have been updated to support this, set to false to
 * ignore and simply accept the connection to the server.
 **/
