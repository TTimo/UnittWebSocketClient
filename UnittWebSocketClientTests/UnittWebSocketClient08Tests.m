...
#import "UnittWebSocketClient08Tests.h"
#import "WebSocketFragment.h"


@implementation UnittWebSocketClient08Tests
...
{
    [super setUp];
    ws = [[WebSocket08 webSocketWithURLString:@"ws://10.0.1.5:8080/testws/ws/test" delegate:self origin:nil protocols:[NSArray arrayWithObject:@"blue"] tlsSettings:nil verifyHandshake:YES] retain];
